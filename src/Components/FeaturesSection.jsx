    ...
    <section className="py-16 bg-gray-50 dark:bg-gray-900 transition-colors duration-300 mt-80">
      <div className="container mx-auto px-5 ">
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-12 text-gray-900 dark:text-gray-100">
          Powerful Features of <span className="text-blue-600 dark:text-blue-400">AssetVerse</span>
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {features.map((item) => (
            <div
              key={item._id}
              className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow hover:shadow-lg transition text-center border border-gray-200 dark:border-gray-700"
            >
